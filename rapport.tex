...
Contrairement au calcul d'un pas $t_k$ exact (optimal), la recherche linéaire inexacte fait usage d'un intervalle de sécurité pour lequel on qualifie le pas $t_k$ de convenable, ou au contraire trop petit ou trop grand. Il existe plusieurs règles caractérisant l'intervalle de sécurité. Parmi elles, on s'intéresse aux règles d'Armijo, Golstein et Wolfe-Powell.
