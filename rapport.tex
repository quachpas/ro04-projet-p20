...
La recherche de l'optimum global d'une fonction s'apparente à la recherche des zéros de son gradient. 
\begin{definition}
    Soit une fonction $f:\Omega \in \mathbb{R}^n\rightarrow \mathbb{R}$, $f$ deux fois continûment dérivable, strictement convexe et de hessienne K-lipschitzienne.
\end{definition}
% Introduction objectif. Redéfinition méthode de newton raphson.
