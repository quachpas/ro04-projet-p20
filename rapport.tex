        ...
        \fbox{
            \begin{minipage}[t]{150mm}
                ...
                \begin{tabbing}
                    ...
                    \line{LINE-07} \> {\bf Si} $t$ est trop grand, {\bf alors} $\beta=t$.\\
                    ...
                    \line{LINE-13} \> {\bf Tant que } $t$ ne convient pas {\bf faire :}\\
                    \line{LINE-14} \>\> $t=\frac{\alpha+\beta}{2}$ ou $t_{\texttt{WP}}=\alpha + \frac{-3(\varphi(\beta)-\varphi(\alpha))+(\beta-\alpha)(2\varphi'(\alpha)+\varphi'(\beta)))+\sqrt{blablabla}}{}$\\
                    % TODO : compléter l'interpolation cubique
                    \line{LINE-14} \>\> {\bf Si } $t$ est trop petit {\bf alors}\\
                    %------------------
                \end{tabbing}
                \normalsize
            \end{minipage}
